        ...
        <Overlay onClose={() => setLogM(false)}>
          <div style={{ padding: 44, textAlign: "center" }}>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              ...
              <button onClick={() => setLogM(false)} style={{ flex: 1, fontFamily: FONT, fontWeight: 700, fontSize: 13, background: "#EF4444", color: "white", border: "none", cursor: "pointer", borderRadius: 10, padding: "11px" }}>Sí, salir</button>
            </div>
          </div>
        </Overlay>
      )}
      ...
      <div style={{ display: "flex", height: "100vh", fontFamily: FONT, overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, overflowY: "auto", backgroundColor: "white", position: "relative" }}>
          ...
          <div style={{ position: "relative", zIndex: 1, minHeight: "100%" }}>
            {Section && <Section state={state} setState={setState} />}
          </div>
        </div>
