...
const GS = () => (
  <style>{`
    @import url('https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700&family=DM+Mono:wght@400;500&family=Heebo:wght@900&display=swap');
      ...
      {tab === "soporte" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <Card style={{ padding: 22 }}>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              {[["✉️","Email","#6B7280","#F9FAFB"],["📲","WhatsApp","#15803D","#F0FDF4"]].map(([icon, label, color, bg]) => (
                <button key={label} style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 7, background: bg, border: "none", borderRadius: 11, padding: "13px", fontFamily: FONT, fontWeight: 500, fontSize: 13, color, cursor: "pointer" }}>
                  {icon} {label}
                </button>
              ))}
            </div>
          ...
          <Card style={{ padding: 22 }}>
            ...
            <PBtn accent={accent} onClick={() => { setSent(true); setFb(""); setTimeout(() => setSent(false), 3000); }} style={{ marginTop: 10 }}>
              {sent ? "✅ Enviado" : "Enviar"}
            </PBtn>
          </Card>
        </div>
        ...
        <div style={{ width: 210, minWidth: 210, backgroundColor: sidebarColor, display: "flex", flexDirection: "column", transition: "background 0.35s" }}>
          ...
          <div style={{ padding: "12px 14px 16px", borderTop: "1px solid rgba(255,255,255,0.07)" }}>
            <img
              ...
              alt="Flow"
              style={{ width: "75%", maxWidth: 130, height: "auto", display: "block", margin: "0 auto", opacity: 0.92 }}
            />
